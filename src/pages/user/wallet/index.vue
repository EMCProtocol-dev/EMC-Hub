<template>
  <NSpace vertical :size="[0, 24]">
    ...
    <PayPoint v-model:visible="showPay" :payInfo="payInfo" :is-custom="payCustom" />
...
const initList = async () => {
  ...
  newList.push({ id: -1, name: 'Custom Pay', price: 1, original: 1, credits: 1000, hot: false })
  list.value = newList;
}
const showPay = ref(false);
const payInfo = ref();
const payCustom = ref(false);
