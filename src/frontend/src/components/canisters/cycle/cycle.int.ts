...
export default interface _SERVICE {
    ...
    set_authorized_subnetwork_list: (arg_0: SetAuthorizedSubnetworkListArgs) => Promise<undefined>;
    transaction_notification: (arg_0: TransactionNotification) => Promise<Result>;
}
