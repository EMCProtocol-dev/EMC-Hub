<template>
   <NSpace align="center" justify="center" :wrap-item="false" style="background-color: #f9f9f9">
      <NSpace class="content" :wrap-item="false">
         <NCard :bordered="false" content-style="padding:0;height:100%"
                           ...
                           <div class="header">
                              <div class="header-row">
                                 <NSpace align="center" justify="center" :wrap-item="false"
                                    style="width: 40px; height: 40px; background-color: #f5f5f5; border-radius: 100%; flex-shrink: 0">
                                    <NIcon size="24">
                                 ...
                                 <NSpace vertical :size="[0, 0]">
                                    ...
                                    <NH6 class="item-body-row" style="font-size: 12px; color: #666">{{
                                       moment(imageInfo.createTime).fromNow() }}</NH6>
                                 </NSpace>
...
export default defineComponent({
   name: 'model-images',
   components: { NLayout, NSpace, NGrid, NGridItem, NCard, NScrollbar, NSpin, NCarousel, NTag, NH3, NH4, NH6, NButton, NIcon, NAvatar, IconStar, IconClose, IconCopy, IconPlay, IconPerson },
   setup() {
