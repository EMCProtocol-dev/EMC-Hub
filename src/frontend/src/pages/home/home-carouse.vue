<template>
   <div class="carouse" :style="carouseStyle.style">
      <NGrid cols="1 976:2" :x-gap="0" :y-gap="56" item-responsive style="position: absolute; z-index: 1; height: 100%">
         <NGridItem>
            <!-- <NSpace :wrap-item="false"> -->
            <NSpace class="carouse-box" :wrap-item="false" :vertical="true" justify="center"
               :align="isMobile || isTablet ? 'center' : 'start'" :style="titleStyle.style">
               <NH2 class="carouse-title">Fully <span class="carouse-title-span">Decentralized</span> Al Application</NH2>
               <NH4 class="carouse-content">With the help of idle GPU computing power distributed on EdgeMatrix worldwide,
                  you can generate the AI images you desire from anywhere at any time. It is a fully decentralized AI
                  platform. </NH4>
         ...
         <NGridItem>
            <NSpace class="carouse-cover" :vertical="true" :wrap-item="false" justify="center"
...
export default defineComponent({
   ...
   setup(props, context) {
      ...
      return { titleStyle, carouseStyle, isMobile, isTablet };
   },
});
</script>
<style scoped>
